...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['product_id'])) {
    ...
    // Redirect to a page where the cart contents are shown or to continue shopping
    // header('Location: Sopping-cart.php'); // Ensure this page exists to view cart
    // exit();
}
?>
<!DOCTYPE html>
...
<div class="icons">
            ...
            <div class="dropdown">
                ...
                <a href="connection.php"><i class="material-icons icon" >shopping_cart</i>
...
<div class="Top-Categories">
            ...
            <div class="cards">
                <div class="card">
                <div class="img-icon">
                    <a href="Medical Supplies.php"><img src="im\صوره شاش.png"></a>
            ...
            <!--card 2-->
                <div class="card">
                    <div class="img-icon">
                        <a href="Diabetics & Pressure.php"><img src="im\جهاز ضغط.png"></a>
                    </div>
            ...
            <div class="card">
                <div class="img-icon">
                    <a href="Bathroom chairs.php"><img src="im\كرسي حمام.png"></a>
                </div>
                <div class="info">
   ...
   <div class="card">
                <div class="img-icon">
                    <a href="Steam Appliances.php"><img src="im\بخار.png"></a>
                </div>
                <div class="info">
            ...
            <div class="card">
                <div class="img-icon">
                    <a href="Bathroom swan.php"><img src="im\مساعده على الحركه.png"></a>
                </div>
                <div class="info">
                    <span>Elderly</span>
                </div>
