...
if ($result) {
    echo "<h2>Diabetics & Pressure devices</h2>";
    echo "<div class='row'>";
    while ($row = pg_fetch_assoc($result)) {
        ...
        echo "<button type='submit' name='action' value='compare'>Compare</button>";
        echo "</form>";
    ...
    <div class="footer">
        <div class="footer-left">
            ...
            <ul class="footer-links">
                ...
                <i class="material-icons arrow_forward" style="  margin-left:40px;">arrow_forward_ios</i>
